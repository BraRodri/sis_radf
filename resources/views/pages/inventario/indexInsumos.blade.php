<x-app-layout>
    ...
    @section('pagina')
        Insumos sanidad militar
    @endsection

    <div class="container-fluid m-0 p-0">
        <div class="bg-principal text-center">
            <h3>Insumos sanidad militar</h3>
        </div>
    </div>
                ...
                @if (Session::has('error'))
                    @if (Session::get('error') == 'success')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Insumo añadido!</strong> Se proceso la información exitosamente.
                    ...
                    @if (Session::get('error') == 'success_updated')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Insumo Actualizado!</strong> Se proceso la información correctamente.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    @if (Session::get('error') == 'delete')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Insumo Eliminada!</strong> Se ha elimiando correctamente el insumo.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="col-12">
                <div class="card shadow">
                    <div class="card-header d-flex align-content-center flex-wrap">
                        <h5 class="mr-auto p-2"><i class="fas fa-envelope-open-text"></i> Insumos sanidad militar</h5>
                    ...
                    <div class="card-body">
                        @if(count($productos) === 0)
                            <div class="text-center align-self-center">
                                <h2 class="text-center mt-3">¡Aún no hay insumos registrados!</h2>
                                <div class="row">
                                    <div class="col-md-4">
                                    </div>
                                ...
                                <h5>Para agregar un insumo da clic en el botón "Añadir"</h5>
                            </div>
                        @else
