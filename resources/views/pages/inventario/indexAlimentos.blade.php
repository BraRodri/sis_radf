                ...
                @if (Session::has('error'))
                    @if (Session::get('error') == 'success')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Alimento añadido!</strong> Se proceso la información exitosamente.
                    ...
                    @if (Session::get('error') == 'success_updated')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Alimento Actualizado!</strong> Se proceso la información correctamente.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    @if (Session::get('error') == 'delete')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Alimento Eliminado!</strong> Se ha elimiando correctamente el producto.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="col-12">
                <div class="card shadow">
                    <div class="card-header d-flex align-content-center flex-wrap">
                        <h5 class="mr-auto p-2"><i class="fas fa-pizza-slice"></i> Alimentos</h5>
                    ...
                    <div class="card-body">
                        @if(count($productos) === 0)
                            <div class="text-center align-self-center">
                                <h2 class="text-center mt-3">¡Aún no hay alimentos registrados!</h2>
                                <div class="row">
                                    <div class="col-md-4">
                                    </div>
                                ...
                                <h5>Para agregar un alimento da clic en el botón "Añadir"</h5>
                            </div>
                        @else
