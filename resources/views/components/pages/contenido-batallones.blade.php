<div class="card shadow">
    <div class="card-header d-flex align-content-center flex-wrap">
        ...
        <button class="ml-auto btn btn-outline-primary" data-toggle="modal" data-target="#modalAgregarBatallones{{ $idbatallon }}">
...
<div class="modal fade" id="modalAgregarBatallones{{ $idbatallon }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('seccional.batallon.create') }}" method="POST" id="form-agg-usuario-batallon" class="needs-validation form-agg-usuario-brigada" novalidate enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <input type="hidden" name="batallon_id" value="{{ $idbatallon }}">
