<x-app-layout>
    ...
    @section('pagina')
        Armamento y nutrición
    @endsection

    <div class="container-fluid m-0 p-0">
        <div class="bg-principal text-center">
            <h3>Armamento y nutrición</h3>
        </div>
    </div>
                ...
                @if (Session::has('error'))
                    @if (Session::get('error') == 'success')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Arma añadida!</strong> Se proceso la información exitosamente.
                    ...
                    @if (Session::get('error') == 'success_updated')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Arma Actualizada!</strong> Se proceso la información correctamente.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    @if (Session::get('error') == 'delete')
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>¡Arma Eliminada!</strong> Se ha elimiando correctamente el arma.
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="col-12">
                <div class="card shadow">
                    <div class="card-header d-flex align-content-center flex-wrap">
                        <h5 class="mr-auto p-2"><i class="fas fa-bomb"></i> Armamento y nutrición</h5>
                    ...
                    <div class="card-body">
                        @if(count($productos) === 0)
                            <div class="text-center align-self-center">
                                <h2 class="text-center mt-3">¡Aún no hay armas registradas!</h2>
                                <div class="row">
                                    <div class="col-md-4">
                                    </div>
                                ...
                                <h5>Para agregar un arma da clic en el botón "Añadir"</h5>
                            </div>
                        @else
